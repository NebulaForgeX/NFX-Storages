...
pub const RRS_ENV: &str = "NEUBULAFX_STORAGE_CLASS_RRS";
// Standard storage class environment variable
pub const STANDARD_ENV: &str = "NEUBULAFX_STORAGE_CLASS_STANDARD";
// Optimize storage class environment variable
pub const OPTIMIZE_ENV: &str = "NEUBULAFX_STORAGE_CLASS_OPTIMIZE";
