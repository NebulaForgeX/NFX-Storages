...
pub struct WarmBackendNebulaFX(WarmBackendS3);

impl WarmBackendNebulaFX {
    pub async fn new(conf: &TierNebulaFX, tier: &str) -> Result<Self, std::io::Error> {
...
impl WarmBackend for WarmBackendNebulaFX {
