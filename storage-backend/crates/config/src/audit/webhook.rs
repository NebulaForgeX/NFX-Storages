...
pub const ENV_AUDIT_WEBHOOK_ENABLE: &str = "NEUBULAFX_AUDIT_WEBHOOK_ENABLE";
pub const ENV_AUDIT_WEBHOOK_ENDPOINT: &str = "NEUBULAFX_AUDIT_WEBHOOK_ENDPOINT";
pub const ENV_AUDIT_WEBHOOK_AUTH_TOKEN: &str = "NEUBULAFX_AUDIT_WEBHOOK_AUTH_TOKEN";
pub const ENV_AUDIT_WEBHOOK_QUEUE_LIMIT: &str = "NEUBULAFX_AUDIT_WEBHOOK_QUEUE_LIMIT";
pub const ENV_AUDIT_WEBHOOK_QUEUE_DIR: &str = "NEUBULAFX_AUDIT_WEBHOOK_QUEUE_DIR";
pub const ENV_AUDIT_WEBHOOK_CLIENT_CERT: &str = "NEUBULAFX_AUDIT_WEBHOOK_CLIENT_CERT";
pub const ENV_AUDIT_WEBHOOK_CLIENT_KEY: &str = "NEUBULAFX_AUDIT_WEBHOOK_CLIENT_KEY";
