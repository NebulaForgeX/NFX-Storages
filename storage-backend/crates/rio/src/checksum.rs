...
/// NebulaFX multipart checksum metadata key
pub const NEUBULAFX_MULTIPART_CHECKSUM: &str = "x-nebulafx-multipart-checksum";

/// NebulaFX multipart checksum type metadata key  
pub const NEUBULAFX_MULTIPART_CHECKSUM_TYPE: &str = "x-nebulafx-multipart-checksum-type";
