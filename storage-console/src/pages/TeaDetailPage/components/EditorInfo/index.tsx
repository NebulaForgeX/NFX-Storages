...
import { Calendar, Clock, User } from "@/assets/icons/lucide";
      ...
      <div className={styles.infoGrid}>
        {editorName && (
          <div className={styles.infoItem}>
            ...
            <div className={styles.infoValue}>{editorName}</div>
          </div>
        )}
        ...
        {deletedAt && (
          <div className={styles.infoItem}>
            ...
            <div className={`${styles.infoValue} ${styles.deleted}`}>{formatDate(deletedAt)}</div>
          </div>
        )}
      </div>
    </div>
