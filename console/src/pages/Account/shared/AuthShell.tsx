import { AnimatedIcon, ArrowNarrowLeftIcon, CpuIcon, LockIcon, SendIcon } from "nfx-ui/icons";
...
export default function AuthShell({ brandTitle, brandEyebrow, heroFooter, children }: AuthShellProps) {
  ...
  const pillars = [
    { icon: CpuIcon, title: t("pillarIdentityTitle"), body: t("pillarIdentityBody") },
    { icon: LockIcon, title: t("pillarCommunityTitle"), body: t("pillarCommunityBody") },
    { icon: SendIcon, title: t("pillarLinkTitle"), body: t("pillarLinkBody") },
  ] as const;
