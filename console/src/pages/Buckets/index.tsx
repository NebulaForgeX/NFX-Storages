import { GearIcon, LockIcon, ShieldCheck, HashtagIcon } from "nfx-ui/icons";
...
export default function BucketsPage() {
  ...
  return (
    <PageFrame>
      <PageHeader icon={GearIcon} title={bucket} description={t("Settings")} />
      ...
      {data ? (
        <Flex direction="column" gap="4">
          <Card>
            <CardHeader icon={<ShieldCheck size={18} />} title={t("Versioning")} />
          ...
          <Card>
            <CardHeader icon={<LockIcon size={18} />} title={t("Access Policy")} />
            <TextArea
              value={currentPolicy}
          ...
          <Card>
            <CardHeader icon={<HashtagIcon size={18} />} title={t("Tags")} />
            <TextArea
              value={currentTags}
          ...
          <Card>
            <CardHeader icon={<LockIcon size={18} />} title={t("Object Lock")} />
          ...
          <Card>
            <CardHeader icon={<LockIcon size={18} />} title={t("Encryption")} />
